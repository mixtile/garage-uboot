...
#define CLK_DIV_CPU0_REG		__REG(ELFIN_CLOCK_BASE+CLK_DIV_CPU0_OFFSET)
#define CLK_DIV_CPU1_REG		__REG(ELFIN_CLOCK_BASE+CLK_DIV_CPU1_OFFSET)

#define CLK_DIV_TOP     __REG(ELFIN_CLOCK_BASE+CLK_DIV_TOP_OFFSET)
