...
#define CONFIG_DEVBOARD          /* 开发板 */

#define BOOT_MMC  0             /*从 mmc0 启动*/
#define HSMMC0_SPEED 50000000     /* mmc0 clock最大速度*/
#define MMC2_SPEED 25000000     /* mmc2 clock最大速度*/
...
/* 
  分区信息：
  名称        大小      地址空间                  块空间 
  bootloader  (3M)      0x00000000 ~ 0x002FFFFF    0     ~ 6143 (6144)(包括RESERVE BL1 uboot三部分)
...
#define RAMDISK_READ_SIZE     (0x400000)    //启动时读取的长度，优化启动时间，跟据ramdisk文件大小做调整
